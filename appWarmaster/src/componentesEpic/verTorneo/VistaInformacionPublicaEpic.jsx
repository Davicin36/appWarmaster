...
function VistaInformacionEpic({ inscritos, tipoTorneo, estadoTorneo, torneoId }) {
    ...
    const handleVerLista = async (jugador) => {
        ...
        try {
            ...
            setError('');
            await torneosEpicApi.verListaPDFJugador(torneoId, jugador.jugador_id);
        } catch (err) {
    ...
    const handleDescargarLista = async (jugador) => {
        ...
        try {
            setLoadingPdf(jugador.jugador_id);
            setError('');
            await torneosEpicApi.descargarListaEjercito(torneoId, jugador.jugador_id);
        } catch (err) {
...
export default VistaInformacionEpic;