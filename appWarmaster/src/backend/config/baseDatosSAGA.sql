...
CREATE TABLE jugador_torneo_saga (
  ...
  composicion_ejercito VARCHAR(200) NULL,
...
CREATE TABLE clasificacion_equipos_saga (
  ...
  puntos_torneo_eq_totales DECIMAL (10,1) DEFAULT 0,
...
CREATE TABLE partidas_saga (
  ...
  mision_secundaria_j1 TINYINT(1) DEFAULT 0,
  mision_secundaria_j2 TINYINT(1) DEFAULT 0,
