...
function VistaInformacionDracula({ inscritos, tipoTorneo, estadoTorneo, torneoId }) {
    ...
    const handleVerLista = async (jugador) => {
        ...
        try {
            ...
            setError('');
            await torneosDraculaApi.verListaPDFJugador(torneoId, jugador.jugador_id);
        } catch (err) {
    ...
    const handleDescargarLista = async (jugador) => {
        ...
        try {
            setLoadingPdf(jugador.jugador_id);
            setError('');
            await torneosDraculaApi.descargarListaEjercito(torneoId, jugador.jugador_id);
        } catch (err) {
                            ...
                            return (
                                <div key={inscrito.id} className="card-inscrito">
                                    ...
                                    <div className="banda-info">
                                        <p><strong>Nombre Banda:</strong> {inscrito.nombre_banda || "Sin definir"}</p>
                                        <p><strong>Banda:</strong> {inscrito.banda || "Sin definir"}</p>
                                    </div>
...
export default VistaInformacionDracula;