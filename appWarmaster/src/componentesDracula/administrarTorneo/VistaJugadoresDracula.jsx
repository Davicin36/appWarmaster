...
function VistaJugadoresDracula({ torneoId: propTorneoId, torneo, jugadores: propJugadores, onUpdate }) {
    ...
    const cargarDatos = async () => {
        try {
            setLoading(true);
            const { data } = await torneosDraculaApi.obtenerJugadoresTorneo(torneoId);
    ...
    const verListaPDF = async (jugadorId, nombreJugador) => {
        try {
            ...
            await torneosDraculaApi.verListaPDFJugador(torneoId, jugadorId);
    ...
    const cambiarEstadoPagoJugador = async (jugadorId, estadoActual) => {
        ...
        try {
            ...
            await torneosDraculaApi.actualizarPagoJugador(torneoId, jugadorId, nuevoEstado);
    ...
    const eliminarJugador = async (jugadorId) => {
        ...
        try {
            await torneosDraculaApi.eliminarJugadorTorneo(torneoId, jugadorId);
    ...
    const reenviarInvitacionTodosJugadores = async () => {
        ...
        try {
            ...
            const response = await torneosDraculaApi.reenviarInscripcionTodosJugadores(torneoId);
    ...
    const reenviarInvitacionIndividual = async (jugador) => {
        ...
        try {
            ...
            const response = await torneosDraculaApi.reenviarInscripcionJugador(torneoId, jugador.id);
        ...
        try {
            ...
            await Promise.all(
                jugadoresPendientes.map(j =>
                    torneosDraculaApi.actualizarPagoJugador(torneoId, j.id, 'pagado')
                )
            );
...
export default VistaJugadoresDracula;