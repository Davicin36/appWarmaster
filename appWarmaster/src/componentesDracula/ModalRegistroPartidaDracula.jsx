...
function ModalRegistroPartidaEpic({ partida, onClose, onGuardar, esOrganizador = false }) {
    ...
    const handleGuardar = async () => {
        try {
            ...
            await torneosDraculaApi.registrarPartida(partida.torneo_id, partida.id, {
    ...
    const handleConfirmar = async (confirmar) => {
        try {
            ...
            await torneosDraculaApi.confirmarResultado(partida.torneo_id, partida.id, confirmar);
