...
class TorneosDraculaApi {
  constructor() {
    this.baseURL = `${API_BASE_URL}/torneosDracula`;
  }
  ...
  async reenviarInscripcionJugador (torneoId, jugadorId) {
  ...
  async obtenerPartidasTorneo(torneoId, ronda) {
    const endpoint = ronda 
      ? `/${torneoId}/partidasTorneoDracula?ronda=${ronda}`
      : `/${torneoId}/partidasTorneoDracula`;
  ...
  async obtenerPartida(torneoId, partidaId) {
    return this.request(`/${torneoId}/partidasTorneoDracula/${partidaId}`);
  }
  ...
  async confirmarResultado(torneoId, partidaId, confirmar) {
    return this.request(`/${torneoId}/partidasTorneoDracula/${partidaId}/confirmar`, {
      method: 'PATCH',
      body: { confirmar }
    });
  }
...
export const torneosDraculaApi = new TorneosDraculaApi();
export default torneosDraculaApi;